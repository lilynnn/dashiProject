        ...
        <div id="enroll-form">
            <form action="">
                ...
                <table id="table">
                    ...
                    <tbody id="tbody">      
                        ...
                        <tr>
                            ...
                            <td height="300px"><textarea name="content" cols="87" rows="10" required style="resize: none;"></textarea></td>
                        </tr>        
                    </tbody>
                ...
                <div align="center" style="margin-top: 20px;">
                    <button type="submit" class="btn btn-sm" style="background: rgb(102,184,94);">작성하기</button>
                    <button type="reset" class="btn btn-sm" style="background: rgb(143,153,142);">취소하기</button>
                </div>
