			...
			<div class="content-area">
				...
				<table align="center" id="animalInfo" style="width: 900px;">
					...
					<tbody>
						...
						<tr>
							<th>묘종 / 견종</th>
							<td colspan="2"><input name="animalVariety" type="text"></td>
						</tr>

						<!-- 동물 나이 -->
						<tr>
							<th>나 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 이</th>
							<td colspan="2"><input name="animalAge" type="text"></td>
						</tr>

						<!-- 동물 성별 -->
						<tr>
							<th>성 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 별</th>
							<td colspan="2"><input name="animalGender" type="text"></td>
						</tr>

						<!-- 접종 여부 -->
						<tr>
							<th>접종 &nbsp; 여부</th>
							<td colspan="2"><input name="animalVaccin" type="text"></td>
						</tr>
						
						<!-- 중성화 여부 -->
						<tr>
							<th>중성화여부</th>
							<td colspan="2"><input name="animalNeutral" type="text"></td>
						</tr>
						
						<!-- 질병 여부 -->
						<tr>
							<th>질병 &nbsp; 여부</th>
							<td colspan="2"><input name="animalDisease" type="text"></td>
						</tr>
						
						<!-- 특이사항 -->
						<tr>
							<th>특이 &nbsp; 사항</th>
							<td colspan="2"><input name="animalIssue" type="text"></td>
						</tr>
