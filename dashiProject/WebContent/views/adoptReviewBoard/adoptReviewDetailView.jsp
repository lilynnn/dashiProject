...
<style>
    ...
    #ReportModal #report-area,#cmtReport #report-area{padding:10px;}
    #ReportMoadl table, #cmtReport table{
        margin: 12px; 
        width: 500px; 
        font-size: 13px;
    }
    #ReportModal table>label,#cmtReport table>label{font-size: 13px;}
