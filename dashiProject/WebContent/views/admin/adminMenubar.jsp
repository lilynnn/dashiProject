        ...
        <div id="aMenubar">
            ...
            <div id="menu-list" style="height: 670px;">
                ...
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath()%>/blackList.ad" class="menu-detail">블랙리스트조회</a></li>
                </ul>
                
                <div class="aMenu" id="apply">신청내역관리</div>
                <ul>
                	<li><a href="<%= request.getContextPath()%>/adplist.ad?cpage=1" class="menu-detail">입양신청</a></li>
                    <li><a href="<%= request.getContextPath()%>/entListView.ad?cpage=1" class="menu-detail">입소신청</a></li>
                </ul>
                ...
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath()%>/adlist.as" class="menu-detail">1:1문의</a></li>
