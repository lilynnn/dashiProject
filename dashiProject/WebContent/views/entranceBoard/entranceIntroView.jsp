...
<style>
    ...
    <div class="outer">
        ...
        <!-- 이미지2 -->
        <div class="int-2" style="display: flexbox;">
            <img class="image2" src="<%=contextPath%>/resources/images/testimg.jpg">

            <div style="display: inline-block;">
               <br><br clear="both">
                <div class="int-text" style="margin-top: 30px;">
                    <b class="title">다시, 사랑받개! 의 원칙</b>  <br> <br>
                    첫번째, 보호소라고하면 어떤 느낌이 드시나요? <br>
                    저희는 보호소라는 공간을 따듯함이 떠오르는 공간이 되도록 노력하겠습니다. <br>
                    사람의 기준이 아닌 아이들의 입장에서 낯선 공간에서도 잘 어울릴 수 있도록 <br>
